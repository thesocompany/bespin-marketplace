...
} from './FooterExtendedNavList'
import classnames from 'classnames'
// import { deprecationWarning } from '../../../deprecation'

function isExtendedNavLinks() {
  return (ExtendedNavLinksType)[0].constructor === Array
}
...
export const FooterNav = ({
  ...
  if (big) {
    console.log('FooterNav property big is deprecated.  Use size')
  }
  if (medium) {
    console.log('FooterNav property medium is deprecated.  Use size')
  }
  if (slim) {
    console.log('FooterNav property slim is deprecated.  Use size')
  }
