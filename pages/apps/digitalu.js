...
export default function DigitalU() {
  return (
    <>
      <Head>
            ...
            <div className="grid-row">
              ...
              <div className="grid-col-4">
                <div className={styles.thisisatest}>
                  <h1 className={styles.projectCenterTitle}>Digital U</h1>
                  <p className={styles.projectSubheading}>Online learning platform catering to warfighters by offering courses to improve their technical skills.
                  </p>
            ...
            <div className="grid-row margin-top-3">
              <div className="grid-col-7">
                <p className={styles.projectPageBodyTextAdjusted}>
                  Digital University is an online learning platform catering to warfighters by offering courses 
                  to improve their technical skills. DU is revitalizing the way the Air Force and the United States 
                  Space Force train its cyber warriors by providing integrated training pathways that guide users 
                  toward desired end results. Committed to realizing BESPIN’s goal of having solution centers complete 
                  the app delivery process from ideation to delivered product in as little as 88 days.
                </p>
                  ...
                  <div className={styles.homeBoxMissonWelcome}>
                    ...
                    <ul style={{maxWidth: "392px"}}>
                      <li className="margin-bottom-2">
                        Courses offered from BESPIN vendor partners, including Udemy, Udacity, and Pluralsight
                      </li>
                      <li className="margin-bottom-2">
                        Digital University interfaces with the Digital LEAP and Drudonna programs
                      </li>
                      <li className="margin-bottom-2">
